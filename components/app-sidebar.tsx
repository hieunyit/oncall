...
const NAV_SECTIONS = [
  { label: "Van hanh", items: ["/dashboard", "/schedule", "/alerts", "/integrations"] },
  { label: "Cau hinh", items: ["/teams", "/policies", "/escalation", "/runbooks"] },
  { label: "Quan ly", items: ["/incidents", "/swaps", "/reports", "/notifications", "/users"] },
];
      ...
      <div className="h-16 flex items-center px-4 border-b border-slate-700/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs">Quan ly lich truc</p>
          </div>
        </div>
      </div>
