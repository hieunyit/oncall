...
ALTER TABLE "schedule_batches" DROP CONSTRAINT "schedule_batches_policy_id_fkey";
...
ALTER TABLE "shifts" DROP CONSTRAINT "shifts_policy_id_fkey";
ALTER TABLE "shifts" ADD CONSTRAINT "shifts_policy_id_fkey"
  FOREIGN KEY ("policy_id") REFERENCES "rotation_policies"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- 3. SwapRequest must cascade when the original Shift is deleted
ALTER TABLE "swap_requests" DROP CONSTRAINT "swap_requests_original_shift_id_fkey";
...
ALTER TABLE "swap_requests" DROP CONSTRAINT "swap_requests_target_shift_id_fkey";
